...
export default function Intro() {
  const titles = ["Full-Stack & DevOps Engineer", "Cloud Architecture Specialist", "Machine Learning Enthusiast", "Scalable Systems Developer"];
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-10 mt-4 px-4">
        ...
        >
          My work spans{" "}
          <Highlight gradient="backend">backend development</Highlight>,{" "}
          <Highlight gradient="cloud">cloud architecture</Highlight>,{" "}
          <Highlight gradient="ml">machine learning</Highlight>,{" "}
          <Highlight gradient="dist">DevOps automation</Highlight>,   and{" "}
      ...
      >
        ...
        <a
          ...
          href="/images/Ankit_Suresh_Raut_Resume.pdf"
          download="Ankit_Suresh_Raut_Resume.pdf"
        >
          Download CV
        ...
        <a
          ...
          href="https://www.linkedin.com/in/ankitraut4"
          target="_blank"
        >
          <BsLinkedin />
        </a>
